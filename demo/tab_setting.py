...
def tab_setting(config):
    ...
    def init_tab():
        ...
        return openai_api_key, openai_base_url, baidu_access_key, baidu_secret_key, chat_context_limit

    tab.select(init_tab, None, [openai_api_key, openai_base_url, baidu_access_key, baidu_secret_key, chat_context_limit])